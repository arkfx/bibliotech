...
class PedidoRepositoryTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->pdo->exec("CREATE TABLE livros (id INTEGER PRIMARY KEY, titulo TEXT, imagem_url TEXT);");
        ...
        $this->pdo->exec("INSERT INTO livros (id, titulo, imagem_url) VALUES (10, 'Livro A', 'url_a'), (11, 'Livro B', 'url_b');");
    ...
    {
        $this->repository->criar(new Pedido(['usuario_id' => 1, 'total' => 10, 'status' => 'a', 'valor_frete' => 0, 'criado_em' => '2025-01-01']));
        $this->repository->criar(new Pedido(['usuario_id' => 1, 'total' => 20, 'status' => 'b', 'valor_frete' => 0, 'criado_em' => '2025-01-02']));
        $this->repository->criar(new Pedido(['usuario_id' => 2, 'total' => 30, 'status' => 'c', 'valor_frete' => 0, 'criado_em' => '2025-01-03']));
    ...
    {
        $pedidoId = $this->repository->criar(new Pedido(['usuario_id' => 1, 'total' => 75, 'status' => 'confirmado', 'valor_frete' => 0, 'criado_em' => '2025-01-01']));
